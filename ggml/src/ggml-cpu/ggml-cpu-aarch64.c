    ...
    if (ggml_cpu_has_neon()) {
        ...
        for (int c = 0; c < nc; c += ncols_interleaved) {
            ...
            for (int b = 0; b < nb; b += 1) {
                int8x16_t b0 = vld1q_s8((int8_t *)b_ptr->qs);
                int8x16_t b1 = vld1q_s8((int8_t *)b_ptr->qs + 16);
                int8x16_t b2 = vld1q_s8((int8_t *)b_ptr->qs + 32);
                int8x16_t b3 = vld1q_s8((int8_t *)b_ptr->qs + 48);

                int8x16_t a0 = vld1q_s8(a_ptr->qs);
                int8x16_t a1 = vld1q_s8(a_ptr->qs + qk/2);

                float16x4_t bd = vld1_f16((__fp16 *)b_ptr->d);
                ...
                float32x4_t fret = vcvtq_n_f32_s32(ret, 4);
                acc = vfmaq_f32(acc, fret, vmulq_f32(vcvt_f32_f16(ad), vcvt_f32_f16(bd)));
